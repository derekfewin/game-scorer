...
console.log("🔥 FIREBASE MODULE LOADED: ROBUST NAME RESOLUTION v2");
...
function resolveNameFromIndex(idx) {
    ...
    // The inputs are generated by js/ui/names.js.
    // They have class "name-selector".
    
    // Check if we are in Team mode by looking for team labels in the DOM
    const isTeamMode = document.querySelector('.team-label') !== null;
    
    if (isTeamMode) {
        // Teams: logic is complex (1-a, 1-b, 2-a...).
        // Let's rely on flat list order of inputs.
